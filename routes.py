...
# Rotas de e-mail movidas para routes_email.py - import removido para evitar conflito de endpoints
...
# Rotas de configuração de e-mail movidas para routes_email.py para evitar conflitos
...
# Função movida para routes_email.py - removida para evitar conflito
