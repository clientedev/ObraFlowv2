...
sqlalchemy.exc.ProgrammingError: (psycopg2.errors.UndefinedColumn) column notificacoes.email_enviado does not exist
LINE 1: ...tificacoes.expires_at AS notificacoes_expires_at, notificaco...
                                                             ^
...
ERROR:app:❌ Erro ao listar notificações: (psycopg2.errors.UndefinedColumn) column notificacoes.email_enviado does not exist
LINE 1: ...tificacoes.expires_at AS notificacoes_expires_at, notificaco...
                                                             ^
[SQL: SELECT notificacoes.id AS notificacoes_id, notificacoes.relatorio_id AS notificacoes_relatorio_id, notificacoes.user_id AS notificacoes_user_id, notificacoes.usuario_origem_id AS notificacoes_usuario_origem_id, notificacoes.usuario_destino_id AS notificacoes_usuario_destino_id, notificacoes.tipo AS notificacoes_tipo, notificacoes.titulo AS notificacoes_titulo, notificacoes.mensagem AS notificacoes_mensagem, notificacoes.link_destino AS notificacoes_link_destino, notificacoes.status AS notificacoes_status, notificacoes.lida_em AS notificacoes_lida_em, notificacoes.created_at AS notificacoes_created_at, notificacoes.expires_at AS notificacoes_expires_at, notificacoes.email_enviado AS notificacoes_email_enviado, notificacoes.email_sucesso AS notificacoes_email_sucesso, notificacoes.email_erro AS notificacoes_email_erro, notificacoes.push_enviado AS notificacoes_push_enviado, notificacoes.push_sucesso AS notificacoes_push_sucesso, notificacoes.push_erro AS notificacoes_push_erro 
FROM notificacoes 
...
(Background on this error at: https://sqlalche.me/e/20/f405)
  File "/usr/local/lib/python3.11/site-packages/sqlalchemy/engine/default.py", line 951, in do_execute
    cursor.execute(statement, parameters)
psycopg2.errors.UndefinedColumn: column notificacoes.email_enviado does not exist
LINE 1: ...tificacoes.expires_at AS notificacoes_expires_at, notificaco...
                                                             ^
